...
prompt = ChatPromptTemplate.from_template(
    "You are a Product Information Agent for TechMart. Describe features, pricing, and availability based on context and provide resutlt in well structure manner.\n\n"
